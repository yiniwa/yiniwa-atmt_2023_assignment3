...
def main(args):
    ...
    src_dict = Dictionary.load(os.path.join(
        args.dicts, 'dict.{:s}'.format(args.source_lang)))
    ...
    tgt_dict = Dictionary.load(os.path.join(
        args.dicts, 'dict.{:s}'.format(args.target_lang)))
    ...
    test_dataset = Seq2SeqDataset(
        src_file=os.path.join(
            args.data, 'test.bpe{:s}'.format(args.source_lang)),
        tgt_file=os.path.join(
            args.data, 'test.bpe{:s}'.format(args.target_lang)),
